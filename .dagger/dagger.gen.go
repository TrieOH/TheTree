...
func (r Thetree) MarshalJSON() ([]byte, error) {
	var concrete struct{}
	return json.Marshal(&concrete)
}

func (r *Thetree) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Thetree":
		...
		case "CI":
			...
			var services string
			if inputArgs["services"] != nil {
				err = json.Unmarshal([]byte(inputArgs["services"]), &services)
				if err != nil {
					panic(fmt.Errorf("%s: %w", "failed to unmarshal input arg services", err))
				}
			}
			return (*Thetree).CI(&parent, ctx, source, services)
		case "Compile":
			var parent Thetree
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Thetree).Compile(&parent, ctx, source, service)
		case "FrontendLintTsc":
			var parent Thetree
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
				panic(fmt.Errorf("%s: %w", "failed to unmarshal parent object", err))
			...
			return (*Thetree).FrontendLintTsc(&parent, ctx, source, services)
		case "Lint":
			var parent Thetree
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Thetree).Lint(&parent, ctx, source, service)
		case "Publish":
			var parent Thetree
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Thetree).Publish(&parent, ctx, source, registryUsername, registryPassword, tag)
		case "Test":
			var parent Thetree
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Thetree).Test(&parent, ctx, source, service)
		case "Trivy":
			var parent Thetree
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Thetree).Trivy(&parent, ctx, source, projects)
		default:
