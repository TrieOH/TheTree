...
function RouteComponent() {
  ...
  const capabilities = Object.values(
    introspectResponse?.subject.capabilities ?? {},
  ).map(String);
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[12px] text-muted-foreground">
              Inspect your current session token
            </p>
          </div>
        </div>
      ...
      <div className="rounded-xl border border-border/60 bg-card shadow-sm p-4 flex flex-col gap-3">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-xs text-muted-foreground">
            Se preenchido, o introspect vai usar `X-API-KEY` em vez da sessão
            atual.
          </p>
        </div>
                  ...
                  data={{
                    ...
                    subject: {
                      ...
                      metadata: Object.values(
                        introspectResponse.subject.metadata ?? {},
                      ).map(String),
                    },
                  }}
                />
          ...
          {showRaw && (
            <div className="rounded-xl border border-border/60 bg-card shadow-sm overflow-hidden">
              <div className="px-4 py-2.5 border-b border-border/60 flex items-center justify-between gap-3">
                ...
                <CopyButton
                  json={JSON.stringify(introspectResponse, null, 2)}
                />
              </div>
