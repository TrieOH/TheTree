/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 23ca7b278feaf216a5f80f2093138d1e)
// Runtime types generated with workerd@1.20260601.1 2026-06-08 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	ASSETS: Fetcher;
	VITE_POSTHOG_KEY: string;
	VITE_TRACING_ENABLED: string;
	VITE_POSTHOG_HOST: string;
	VITE_APP_TITLE: string;
	VITE_API_URL: string;
	VITE_AUTH_API_URL: string;
	VITE_TRIEOH_AUTH_PROJECT_ID: string;
	IDENTITYX_ACCESS_API_KEY: string;
	VITE_STORAGE_URL: string;
	S3_ENDPOINT: string;
	S3_BUCKET: string;
	S3_ACCESS_KEY_ID: string;
	S3_SECRET_ACCESS_KEY: string;
	VITE_UPLOAD_MAX_RETRIES: string;
	VITE_UPLOAD_RETRY_BASE_DELAY_MS: string;
	VITE_UPLOAD_RETRY_MAX_DELAY_MS: string;
	AUTH_SESSION_PASSWORD: string;
	TRACES_OTLP_USER: string;
	TRACES_OTLP_PASSWORD: string;
	TRACES_OTLP_URL: string;
	TRACES_ENABLED: string;
	STORAGE_IMAGE_ALLOWED_TYPES: string;
	STORAGE_IMAGE_MAX_SIZE_BYTES: string;
	STORAGE_IMAGE_UPLOAD_EXPIRES_SECONDS: string;
	STORAGE_IMAGE_MODERATION_MODEL: string;
	STORAGE_IMAGE_MODERATION_PROMPT: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_POSTHOG_KEY" | "VITE_TRACING_ENABLED" | "VITE_POSTHOG_HOST" | "VITE_APP_TITLE" | "VITE_API_URL" | "VITE_AUTH_API_URL" | "VITE_TRIEOH_AUTH_PROJECT_ID" | "IDENTITYX_ACCESS_API_KEY" | "VITE_STORAGE_URL" | "S3_ENDPOINT" | "S3_BUCKET" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "VITE_UPLOAD_MAX_RETRIES" | "VITE_UPLOAD_RETRY_BASE_DELAY_MS" | "VITE_UPLOAD_RETRY_MAX_DELAY_MS" | "AUTH_SESSION_PASSWORD" | "TRACES_OTLP_USER" | "TRACES_OTLP_PASSWORD" | "TRACES_OTLP_URL" | "TRACES_ENABLED" | "STORAGE_IMAGE_ALLOWED_TYPES" | "STORAGE_IMAGE_MAX_SIZE_BYTES" | "STORAGE_IMAGE_UPLOAD_EXPIRES_SECONDS" | "STORAGE_IMAGE_MODERATION_MODEL" | "STORAGE_IMAGE_MODERATION_PROMPT">> {}
}
