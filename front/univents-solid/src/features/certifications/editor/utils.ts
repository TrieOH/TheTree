...
export function clampCertificateValue(
  value: number,
  min: number,
  max: number,
): number {
...
export function loadCertificateImageDimensions(
  src: string,
...
export const loadImageDimensions = loadCertificateImageDimensions;

export function scaleCertificateElements(
