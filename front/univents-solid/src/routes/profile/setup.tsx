...
import { useAuth, AuthLayout } from "@trieoh/identityx-sdk-ts-solid";
...
function ProfileSetup(): JSX.Element {
  ...
  return (
    <AuthLayout class="px-5 py-12 pb-32 sm:px-8">
      <div class="w-full max-w-md z-10 flex flex-col">
        <div class="text-center mb-6">
          <h1 class="font-heading text-3xl font-bold tracking-tight mb-2">Configure seu perfil</h1>
        ...
        >
          ...
          <SetupField label="Nome de usuário" htmlFor="setup-handle">
            <input
              ...
              placeholder="como_voce_quer_ser_encontrado"
