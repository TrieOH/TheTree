...
export interface UrlFieldConfig<TFieldValues extends FieldValues>
  extends BaseFieldConfig<TFieldValues> {
  kind: "url";
  name: FieldPath<TFieldValues>;
  label: string;
...
export interface ToggleFieldConfig<TFieldValues extends FieldValues>
  extends BaseFieldConfig<TFieldValues> {
  kind: "toggle";
...
export interface MoneyFieldConfig<TFieldValues extends FieldValues>
  extends BaseFieldConfig<TFieldValues> {
  kind: "money";
  name: FieldPath<TFieldValues>;
  label: string;
...
export interface DateTimeFieldConfig<TFieldValues extends FieldValues>
  extends BaseFieldConfig<TFieldValues> {
  kind: "datetime";
 ...
 */
export interface ComboboxFieldConfig<TFieldValues extends FieldValues>
  extends BaseFieldConfig<TFieldValues> {
  kind: "combobox";
...
export interface ImageFieldConfig<TFieldValues extends FieldValues>
  extends BaseFieldConfig<TFieldValues> {
  kind: "image";
  name: FieldPath<TFieldValues>;
  label: string;
 ...
 * (e.g. `gallery_urls`). */
export interface GalleryFieldConfig<TFieldValues extends FieldValues>
  extends BaseFieldConfig<TFieldValues> {
  kind: "gallery";
  name: FieldPath<TFieldValues>;
  label: string;
