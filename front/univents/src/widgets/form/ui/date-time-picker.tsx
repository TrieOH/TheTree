...
export function DateTimePicker({
  ...
  const displayValue = useMemo(
    () => (dateValue ? format(dateValue, "dd/MM/yyyy 'às' HH:mm", { locale: ptBR }) : ""),
    [dateValue],
  )
    ...
    <div className={cn("flex flex-col", className)}>
      <Button
        ...
        className={cn(
          ...
          error ? "border-destructive" : "border-border/80 focus-visible:border-primary hover:border-foreground/20",
            ...
            <div className="flex flex-col items-center justify-center gap-2 rounded-xl border border-border/60 bg-muted/20 p-3 sm:min-w-35 sm:border-l">
              ...
              <div className="flex items-center gap-1">
                <div className="flex flex-col items-center">
                  <Button type="button" variant="ghost" size="none" onClick={() => { handleHoursChange(1); }} className={spinBtn} disabled={!dateValue}>
                ...
                <span className="mb-1 font-bold text-muted-foreground/30">:</span>

                <div className="flex flex-col items-center">
                  <Button type="button" variant="ghost" size="none" onClick={() => { handleMinutesChange(1); }} className={spinBtn} disabled={!dateValue}>
                    <ChevronUp className="h-4 w-4" />
                  </Button>
                  <input
                    ref={minutesRef}
