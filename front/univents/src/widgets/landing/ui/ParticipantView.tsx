...
const steps = [
  {
    ...
    desc: "Cadastre-se em segundos com e-mail ou redes sociais. Totalmente gratuito.",
  },
  {
    num: "02",
    title: "Encontre seu evento",
    desc: "Explore eventos por categoria, local ou data. Compre seu ingresso com segurança.",
  },
  {
    num: "03",
    title: "Aproveite a experiência",
    desc: "Apresente seu QR Code na entrada e curta o evento sem preocupação.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Qualquer tipo: shows, festivais, conferências, workshops, esportivos, corporativos, sociais. Não há limitação de categoria ou tamanho.",
  },
  {
    question: "Como recebo o dinheiro das vendas?",
    answer:
      "O repasse é feito diretamente para sua conta bancária em até 2 dias úteis após a transação. Para valores maiores, oferecemos antecipação de recebíveis.",
  },
  {
...
export function ParticipantView() {
  const isAuthenticated =
    useRouteContext({ from: "/" }).auth?.isAuthenticated ?? false;
      ...
      <section className="space-y-8 md:space-y-12">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl md:text-4xl font-semibold text-foreground">
            ...
            <br className="hidden md:block" /> eventos favoritos.
          </h2>
        </div>
