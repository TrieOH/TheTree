...
export function ModeSelector({ current, onChange, isAuthenticated = false }: Props) {
  const ctaLabel = current === 'guest'
    ? (isAuthenticated ? 'Continuar explorando' : 'Criar conta grátis')
    : 'Começar a organizar'
