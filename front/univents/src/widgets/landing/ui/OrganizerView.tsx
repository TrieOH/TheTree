...
const steps = [
  {
    ...
    desc: "Defina detalhes, datas, equipe e fornecedores em poucos minutos com nossos templates prontos.",
  },
  {
    num: "02",
    title: "Organize e gerencie",
    desc: "Acompanhe tarefas, convidados e logística em tempo real com visão unificada de tudo.",
  },
  {
    num: "03",
    title: "Execute com confiança",
    desc: "No dia do evento, tenha controle total com check-ins, timeline ao vivo e comunicação integrada.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Cobramos apenas 8% sobre cada ingresso vendido. Não há taxas de setup, mensalidade mínima ou custos ocultos. Quanto mais você vende, melhores condições podemos oferecer.",
  },
  {
    question: "Preciso pagar alguma mensalidade?",
    answer:
      "Não obrigatoriamente. Nosso plano Starter é gratuito. Planos pagos (Pro e Enterprise) oferecem recursos avançados, mas você só paga se quiser utilizá-los.",
  },
  {
    question: "Quais tipos de eventos posso gerenciar?",
    answer:
      "Qualquer categoria: corporativos, sociais, culturais, esportivos, educacionais. Desde pequenas reuniões até grandes festivais com milhares de participantes.",
  },
  {
    question: "Como recebo o dinheiro das vendas?",
    answer:
      "O repasse é automático para sua conta em até 2 dias úteis. Oferecemos também antecipação de recebíveis para eventos com fluxo de caixa planejado.",
  },
  {
    question: "Posso cancelar a qualquer momento?",
    answer:
      "Sim. Sem contratos de fidelidade ou multas. Se estiver em um plano pago, você continua com acesso até o final do período contratado.",
  },
  {
    question: "A plataforma oferece suporte para check-in no evento?",
    answer:
      "Sim. Temos aplicativo dedicado para check-in, leitura de QR Code offline, controle de múltiplas entradas e relatório de presença em tempo real.",
  },
];
  ...
  const weekDays = ["Seg", "Ter", "Qua", "Qui", "Sex", "Sáb", "Dom"].map(
    (label, idx) => {
      ...
      return {
        ...
        date: d.getDate(),
        isToday:
          d.getDate() === currentMonthDay && d.getMonth() === now.getMonth(),
      };
    },
  );
    ...
    <div className="max-w-5xl mx-auto space-y-20 md:space-y-32">
      ...
      <section className="text-center max-w-2xl mx-auto space-y-4 md:space-y-6 px-2">
        <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
          Planeje, organize e execute eventos de qualquer escala. Do briefing ao
          pós-evento, tudo em uma única plataforma.
        </p>
      ...
      <section className="space-y-8 md:space-y-12">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl md:text-4xl font-semibold text-foreground">
            ...
            <br className="hidden md:block" /> impecáveis.
          </h2>
        </div>
      ...
      <section className="space-y-8 md:space-y-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          {steps.map((step, idx) => (
            ...
            >
              <span className="text-3xl md:text-4xl font-semibold text-muted">
                {step.num}
              </span>
      ...
      <section className="bg-muted rounded-2xl md:rounded-3xl p-6 md:p-12 space-y-6 md:space-y-8">
          ...
          {[
            {
              ...
              desc: "Uma porcentagem justa sobre cada venda realizada no seu evento.",
            },
            {
              title: "Zero custo inicial",
              desc: "Crie sua conta, configure eventos e comece a vender sem pagar nada.",
            },
            {
              title: "Escale sem limites",
              desc: "Quanto mais você vende, mais a plataforma trabalha por você.",
            },
            {
              title: "Pagamento seguro",
              desc: "Processamento protegido com repasse direto para sua conta.",
            },
          ].map((item) => (
            <div key={item.title} className="space-y-1 md:space-y-2">
        ...
        <div className="bg-card border border-border rounded-xl md:rounded-2xl p-4 md:p-6 max-w-md mx-auto">
          <p className="text-xs text-muted-foreground mb-3 md:mb-4 uppercase tracking-wider">
            Exemplo de transação
          </p>
