  ...
  return (
    <div className="calendar-scroll min-w-0 flex-1 overflow-auto">
      <div className="flex min-w-full">
        ...
        <div className="min-w-150 flex-1 border-r border-border relative">
          <div className="sticky top-0 z-20 flex h-19 flex-col items-center justify-center border-b border-border bg-background text-center">
            <div
              ...
              >
                {slotOccs.map((oc) => (
                  <DraggableEvent
                    ...
                    color={programColors[oc.program_id] ?? FALLBACK_EVENT_COLOR}
                    onClick={onCardClick}
                    onDelete={onDelete}
