  ...
  return (
    <div ref={containerRef} className={cn('relative shrink-0', className)}>
      <button
        ...
        className={cn(
          'flex h-7 items-center rounded-md border border-input bg-background text-xs transition-colors hover:bg-muted disabled:pointer-events-none disabled:opacity-45',
          iconOnly
      ...
      {open ? (
        <div className="absolute top-full left-0 z-50 mt-1 w-64 overflow-hidden rounded-lg border bg-popover text-popover-foreground shadow-lg">
