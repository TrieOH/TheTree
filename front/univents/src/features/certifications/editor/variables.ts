...
export type CertificateVariableValues = Partial<Record<CertificateVariableKey, string>>

export function replaceCertificateVariables(text: string, values: CertificateVariableValues): string {
  return text.replace(
...
function resolveElement(element: CertificationTemplateElement, values: CertificateVariableValues): CertificationTemplateElement {
...
export function resolveCertificationTemplate(template: CertificationTemplateDraft, values: CertificateVariableValues): CertificationTemplateDraft {
  return {
    ...template,
    data: {
      ...template.data,
