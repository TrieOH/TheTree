...
import { activityCreateSchema, type ActivityCreateInputI, type ActivityCreateOutputI, type ActivityI } from '../model'
...
export interface ManageActivityModalProps {
  ...
  activity?: ActivityI
  onCreate?: (values: ActivityCreateOutputI) => Promise<ActivityI | null | boolean> | ActivityI | null | boolean
  onUpdate?: (id: string, values: ActivityCreateOutputI) => Promise<ActivityI | null | boolean> | ActivityI | null | boolean
}
...
export function ManageActivityModal({
  ...
  const editValues = useMemo(() => (activity ? toFormValues(activity) : undefined), [activity])
