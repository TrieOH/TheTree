...
import { ticketCreateSchema, type TicketCreateInputI, type TicketCreateOutputI, type TicketI } from '../model'
...
export interface ManageTicketModalProps {
  ...
  ticket?: TicketI
  onCreate?: (values: TicketCreateOutputI) => Promise<TicketI | null | boolean> | TicketI | null | boolean
  onUpdate?: (id: string, values: TicketCreateOutputI) => Promise<TicketI | null | boolean> | TicketI | null | boolean
}
...
export function ManageTicketModal({
  ...
  const editValues = useMemo(() => (ticket ? toFormValues(ticket) : undefined), [ticket])
