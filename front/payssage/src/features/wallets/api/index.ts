 ...
 */
export const createWalletFn = createClientOnlyFn((walletData: WalletCreateI) => {
 ...
 */
export const setWalletFeeBPSFn = createClientOnlyFn((walletId: string, data: WalletSetFeeBpsI) => {
 ...
 */
export const setWalletSandboxFn = createClientOnlyFn((walletId: string, data: WalletSetSandboxI) => {
