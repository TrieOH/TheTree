...
/**
 * A purchasable product for an edition. Mirrors `models.Product`.
 */
export interface Product {
  id: Uuid;
  edition_id: Uuid;
  /** Caller-defined unique product code within the edition. */
  vendor_code: string;
  /** Whether buying this product requires an event registration. */
