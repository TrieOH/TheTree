...
export type BadgeEditionEmissionStatus = typeof BadgeEditionEmissionStatus[keyof typeof BadgeEditionEmissionStatus];


export const BadgeEditionEmissionStatus = {
  active: 'active',
  revoked: 'revoked',
} as const;
