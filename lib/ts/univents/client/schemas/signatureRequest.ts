...
/**
 * A request for a signatory to approve a signature. Fulfillment and
 * denial are authenticated by the request's token (see top-level
 * docs). Mirrors `models.SignatureRequest`.
 */
export interface SignatureRequest {
  ...
  signatory_user_id?: NullableUUID | null;
  /** Key guaranteeing the request is only processed once. */
  ...
  expires_at: string;
  /** Signature produced by fulfillment, once completed. */
  signature_id?: NullableUUID | null;
  created_at: string;
  /** @nullable */
