...
/**
 * The number of confirmed attendees of an edition.
 */
export interface AttendeeCount {
  /**
     * Confirmed (paid) registrations of the edition; pending
     * reservations and cancelled/expired rows are excluded.
     */
  count: number;
}
