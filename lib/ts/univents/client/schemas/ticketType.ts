...
/**
 * A purchasable ticket type. `price_cents` is integer cents. Mirrors `models.TicketType`.
 */
export interface TicketType {
  ...
  /** Minimum access level the ticket grants (gates areas/programs). */
  access_level: number;
  /** Price in integer cents. */
  price_cents: number;
  /**
     * Maximum number of tickets for sale; null = unlimited.
     * @nullable
     */
