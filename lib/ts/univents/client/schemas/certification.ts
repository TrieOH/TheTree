...
/**
 * An emitted certificate. Mirrors `models.Certification`.
 */
export interface Certification {
  ...
  user_id: Uuid;
  /** Program the certificate was emitted for, when program-scoped. */
  program_id?: NullableUUID | null;
  /** Public hash used by the /verify/{hash} endpoint. */
