 ...
 */
import type { CertificationTemplateKind } from './certificationTemplateKind';
import type { CreateCertificationTemplateRequestDesignData } from './createCertificationTemplateRequestDesignData';

/**
 * Request body for certification template creation. Mirrors `models.CreateCertificationTemplateRequest`.
 */
export interface CreateCertificationTemplateRequest {
  ...
  design_data?: CreateCertificationTemplateRequestDesignData;
}
