...
import type { UpdateCertificationTemplateRequestDesignData } from './updateCertificationTemplateRequestDesignData';

/**
 * Request body for certification template updates. Mirrors `models.UpdateCertificationTemplateRequest`.
 */
export interface UpdateCertificationTemplateRequest {
  ...
  design_data?: UpdateCertificationTemplateRequestDesignData;
}
