...
/**
 * One line of a purchase — a reserved/ordered item; `purchase_items` is the availability ledger (D4).
 */
export interface PurchaseItem {
  item_type: PurchaseItemType;
  item_id: Uuid;
  /**
     * How many units of this item the purchase holds.
     * @minimum 1
     */
  quantity: number;
  /** Server-computed unit price at checkout, in cents. */
