 ...
 */
import type { CertificationTemplateDesignData } from './certificationTemplateDesignData';
import type { CertificationTemplateKind } from './certificationTemplateKind';
import type { Uuid } from './uuid';

/**
 * A certificate design template. Mirrors `models.CertificationTemplate`.
 */
export interface CertificationTemplate {
  ...
  /** Opaque design data consumed by the certificate renderer. */
  design_data: CertificationTemplateDesignData;
  created_at: string;
  /** @nullable */
