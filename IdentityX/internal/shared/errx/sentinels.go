...
var (
	...
	ErrKeysInvalidSignature = fail.Form(KeysInvalidSignature, "invalid signature", false, map[string]any{"code": 401}).
				AddLocalization("pt-BR", "assinatura invalida")
	ErrKeysProjectKeyMismatch = fail.Form(KeysProjectKeyMismatch, "project keys mismatch", false, map[string]any{"code": 401}).
					AddLocalization("pt-BR", "chave não bate com a chave do projeto")
