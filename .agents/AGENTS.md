...
| `lib/ts/` | TypeScript       | orval-generated TS clients (types + TanStack Query hooks)                            |
...
- `models/` — domain types (TS bindings generated by orval from `api-spec.yml`)
...
- **orval** — TS client + TanStack Query hooks generated from `api-spec.yml`
...
- `just generate` — regenerate OpenAPI bindings + orval TS clients
