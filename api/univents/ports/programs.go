...
type ProgramRepo interface {
	...
	GetByIDForUpdate(ctx context.Context, id uuid.UUID) (*models.Program, error)
...
type ProgramOccurrenceRepo interface {
	...
	GetOccurrenceByIDForUpdate(ctx context.Context, id uuid.UUID) (*models.ProgramOccurrence, error)
