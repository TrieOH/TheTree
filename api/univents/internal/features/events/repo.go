...
var _ ports.EventsRepository = (*eventsRepo)(nil)
...
func (repo *eventsRepo) CreateEvent(ctx context.Context, toCreate *contracts.Event) (*contracts.Event, error) {
...
func (repo *eventsRepo) PatchEvent(ctx context.Context, toPatch *contracts.Event) (*contracts.Event, error) {
...
func (repo *eventsRepo) GetByID(ctx context.Context, id uuid.UUID) (*contracts.Event, error) {
...
func (repo *eventsRepo) ListEvents(ctx context.Context) ([]contracts.Event, error) {
	ctx, span := repo.tracer.Start(ctx, "EventsRepo.Create")
	defer span.End()
...
func (repo *eventsRepo) ListOwnEvents(ctx context.Context, ownerID uuid.UUID) ([]contracts.Event, error) {
...
func (repo *eventsRepo) AddGalleryImage(ctx context.Context, id uuid.UUID, url string) (*contracts.Event, error) {
...
func (repo *eventsRepo) RemoveGalleryImage(ctx context.Context, id uuid.UUID, url string) (*contracts.Event, error) {
...
func (repo *eventsRepo) SetLogo(ctx context.Context, id uuid.UUID, url string) (*contracts.Event, error) {
...
func (repo *eventsRepo) UnsetLogo(ctx context.Context, id uuid.UUID) (*contracts.Event, error) {
...
func (repo *eventsRepo) SetBanner(ctx context.Context, id uuid.UUID, url string) (*contracts.Event, error) {
...
func (repo *eventsRepo) UnsetBanner(ctx context.Context, id uuid.UUID) (*contracts.Event, error) {
