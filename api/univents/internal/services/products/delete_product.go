...
func (o *Operations) DeleteProduct(ctx context.Context, id uuid.UUID) error {
	...
	existing, err := o.products.GetProductByID(ctx, id)
	if err != nil {
		return err
	}
	...
	return o.products.DeleteProduct(ctx, id)
}
