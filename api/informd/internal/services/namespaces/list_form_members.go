...
func (o *Operations) ListFormMembers(ctx context.Context, namespaceID, formID uuid.UUID) ([]models.FormMember, error) {
	...
	members, err := o.forms.ListDirectMembers(ctx, formID)
	if err != nil {
		return nil, err
	}
	namespaceMembers, err := o.namespaces.ListMembers(ctx, namespaceID)
	if err != nil {
		return nil, err
	}
