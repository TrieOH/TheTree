...
func (uc *CommandService) Register(ctx context.Context, in models.IDXRegisterInput) error {
	var err error
...
func (uc *CommandService) registerInternal(ctx context.Context, in models.IDXRegisterInput) (ports.Email, error) {
	var err error
...
func (uc *CommandService) Login(ctx context.Context, in models.LoginInput) (tokens *models.UserTokensOutput, err error) {
	...
	return &models.UserTokensOutput{
		AccessToken:      security.AssembleJWT(accessPayload, accessSig),
		RefreshToken:     security.AssembleJWT(refreshPayload, refreshSig),
