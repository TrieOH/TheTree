...
func (c *Commands) OAuthCallback(ctx context.Context, provider, code string) (*models.UserTokensOutput, error) {
	...
	info, providerToken, err := c.fetchUserInfo(ctx, provider, code)
	if err != nil {
		return nil, err
	}
...
func (c *Commands) fetchUserInfo(ctx context.Context, provider, code string) (*oauth.UserInfo, *oauth2.Token, error) {
