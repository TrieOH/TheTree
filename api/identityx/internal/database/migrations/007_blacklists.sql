...
CREATE UNIQUE INDEX uniq_blacklist_target_type_project ON blacklist_entries (type, target, project_id) NULLS NOT DISTINCT;
...
DROP INDEX IF EXISTS uniq_blacklist_target_type_project;
