...
func (o *Operations) Create(ctx context.Context, input models.CreateWebhookEndpointInput) (*models.WebhookEndpoint, error) {
	...
	return o.endpoints.Create(ctx, endpoint)
}
