...
export function OAuthProviderButton(props: OAuthProviderButtonProps) {
  ...
  const icon = () => (props.provider === "github" ? <GithubIcon /> : <GoogleIcon />);
  ...
  return (
    <button
      ...
      class="w-full flex items-center justify-center gap-2.5 h-12 px-4 rounded-sm text-sm font-semibold border border-input bg-background hover:bg-muted/60 transition-all disabled:opacity-50 disabled:pointer-events-none active:scale-[0.98]"
    >
      {icon()}
